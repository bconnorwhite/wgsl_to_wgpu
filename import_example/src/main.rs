...
struct State {
    ...
    bind_group1: other::bind_groups::BindGroup1,
...
impl State {
    async fn new(window: &Window) -> Self {
        ...
        let uniforms_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            label: Some("uniforms"),
            contents: bytemuck::cast_slice(&[other::Uniforms {
                color_rgb: [1.0, 1.0, 1.0, 1.0],
            }]),
            usage: wgpu::BufferUsages::UNIFORM,
        });

        let bind_group1 = other::bind_groups::BindGroup1::from_bindings(
            &device,
            other::bind_groups::BindGroupLayout1 {
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        crate::other::bind_groups::set_bind_groups(
            &mut render_pass,
            crate::other::bind_groups::BindGroups {
